...
#3 features, 45 neighbors
# 36 features,  45 neighbors
...
pipe = Pipeline([
    ...
    ('classify', KNeighborsClassifier(weights = 'distance', p = 2, n_neighbors = 44))
])
#N_FEATURES_OPTIONS = np.logspace(-3, 2, 20)
N_FEATURES_OPTIONS = range(40, 50)
...
N_FEATURES_OPTIONS = range(0,20)

bestacc = 0.516680227827502
bestf1 = 0.51586938131539262
bestrocauc = 0.52217796727989008
bestlogloss = -1.6699814497998464
...
keepindex = list(results['mean_test_roc_auc']).index(max(results['mean_test_roc_auc']))
results['mean_test_accuracy'][keepindex]
results['mean_test_f1_weighted'][keepindex]
results['mean_test_neg_log_loss'][keepindex]
N_FEATURES_OPTIONS[keepindex]
